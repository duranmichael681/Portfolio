...
export default function Home() {
  return (
    <div>
      ...
      <main className="bg-white dark:bg-black text-gray-400 ">
        {/* Navbar */}
        <Navbar />

        {/* Centered Content */}

        <section id="intro" className="h-[100vh] flex items-center   bg-black">
          <div className="flex w-full px-10">
            <div className=" w-1/3 ">
              ...
              <a
                ...
                className="flex items-center group" // Add `group` class to the parent
              >
            ...
            <div className="w-1/3  ">
              ...
              >
                Hi, Im{" "}
                <motion.span className="bg-gradient-to-r from-sky-500 to-yellow-500 bg-clip-text text-transparent">
                  Michael Duran
                </motion.span>
              </motion.h1>
              <motion.h1
