    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="Portfolio site showcasing software projects and skills."
        />
        ...
        <section id="projects" className="py-10 h-[80vh]">
          <div className="flex p-5 ">
            <div className=" w-1/3">
              ...
              <p>
                I'm Michael Duran, a passionate software engineer with a strong
                interest in software and web development. As a first-generation
                college student excelling in Computer Science, I continuously
                expand my expertise beyond the classroom by self-learning
                technologies like React, Next.js, Node.js, and MongoDB. I enjoy
                solving problems, building efficient applications, and staying
                engaged with the tech community through programming events and
                continuous learning. Outside of coding, I prioritize personal
                growth and well-being, whether it's spending time with family
                and friends or exploring new challenges in my field.
              </p>
            </div>
